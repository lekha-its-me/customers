    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="app-navbar-collapse">
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><i class="fa fa-list"></i> Отчеты <span class="caret"></span></a>
                    <ul class="dropdown-menu">
                        <li><a href="{{ url('/view') }}">Продажа услуг</a></li>
                        <li><a href="{{ url('/buyingMaterial/report') }}">Покупка материалов</a></li>
                        <li><a href="{{ url('/sell/total') }}">Общий отчет</a></li>
                    </ul>
                </li>
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="{{ url('/buy') }}">Купить материал</a></li>
                    </ul>
                </li>
